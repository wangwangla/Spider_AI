...
public class MClickListener extends InputListener {
    ...
    protected boolean skipGlobalTouchDisable;
    ...
    public void setSkipGlobalTouchDisable(boolean skipGlobalTouchDisable) {
        this.skipGlobalTouchDisable = skipGlobalTouchDisable;
    }
            ...
            if (!cancelled) {
                ...
                if (touchUpOver) {
                    ...
                    if(touchDownX!=-1 && touchDownY!=-1) {
                        if (!Constant.disAble || skipGlobalTouchDisable) {
                            clicked(event, x, y);
                        }
                    }
                }
