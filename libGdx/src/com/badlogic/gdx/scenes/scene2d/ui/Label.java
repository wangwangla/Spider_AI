...
public class Label extends Widget {
	...
	protected void computePrefSize (GlyphLayout layout) {
		...
		if (wrap && ellipsis == null) {
			...
			layout.setText(cache.getFont(),text,0,text.length,Color.WHITE,width,Align.left,false,null,modkerning);
		} else {
			layout.setText(cache.getFont(), text,0,text.length,cache.getFont().getColor(),0,Align.left,false,null,modkerning);
		}
