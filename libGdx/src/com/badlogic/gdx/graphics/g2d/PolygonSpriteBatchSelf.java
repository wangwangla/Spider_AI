...
// * @author Nathan Sweet */
//public class PolygonSpriteBatchSelf implements PolygonBatch {
//    private Mesh mesh;
...
//     * @see #PolygonSpriteBatchSelf(int, int, ShaderProgram) */
//    public PolygonSpriteBatchSelf () {
//        this(2000, null);
//    }
//
...
//     * @see #PolygonSpriteBatchSelf(int, int, ShaderProgram) */
//    public PolygonSpriteBatchSelf (int size) {
...
//     * @param size The max number of vertices and number of triangles in a single batch. Max of 32767.
//     * @see #PolygonSpriteBatchSelf(int, int, ShaderProgram) */
//    public PolygonSpriteBatchSelf (int size, ShaderProgram defaultShader) {
...
//    public PolygonSpriteBatchSelf (int maxVertices, int maxTriangles, ShaderProgram defaultShader) {
